...
const PersonalInfo = () => {
  ...
  return (
    <Box>
        <Box sx={{ position: 'relative', display: 'flex', gap: { lg: '20em', xs: "2.9em" }, bottom: { lg: '2em', md: '6em', xs: '6em' }, left: { lg: '2em', xl: '5em' } }}>
        ...
        <Box sx={{ position: 'relative', bottom: { lg: '.7em', xs: '4em' }, right: '.6em', marginLeft: {lg: '4.4em', xl: '8em'}, display: 'flex', gap: '1em' }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', boxShadow: '0px 0px 2px rgba(0, 0, 0, 0.25)', border: '1px solid #F2F2F2', borderRadius: '10px', width: { lg: '70%', xl: '90%', xs: '90%' }, justifyContent: 'center', margin: { lg: '0 auto' }, ml: { xs: '2.4em' }, mb: { xs: '2em' } }}>
            ...
            <FormControl variant="filled" sx={{ marginBottom: '1em', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '1.5em' }}>
               <Box sx={{ display: 'flex', flexDirection: 'column', gap: '.7em' }}>
                    ...
                    <TextField id="filled-basic" placeholder='Enter your full name' sx={{ width: { lg: '23em', xl: '30em' } }} variant="outlined" required />
               </Box> 
               
               <Box sx={{ display: 'flex', flexDirection: 'column', gap: '.7em' }}>
                    <label>Phone Number</label>
                    <TextField id="filled-basic" placeholder='Enter school phone number' sx={{ width: { lg: '23em', xl: '30em' } }} variant="outlined" required />
               </Box>

               <Box sx={{ display: 'flex', flexDirection: 'column', gap: '.7em' }}>
                    <label>Email Address</label>
                    <TextField id="filled-basic" placeholder='Enter school email address' sx={{ width: { lg: '23em', xl: '30em' } }} variant="outlined" required />
               </Box> 

               <Box sx={{ display: 'flex', flexDirection: 'column', gap: '.7em' }}>
                    <label>Address</label>
                    <TextField id="filled-basic" placeholder='Enter your address' sx={{ width: { lg: '23em', xl: '30em' } }} variant="outlined" required />
               </Box> 
