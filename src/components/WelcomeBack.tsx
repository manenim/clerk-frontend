...
export default function WelcomeBack() {
    return (
       <Container sx={{ mt: { xl: '8em', xs: '6em', lg: '7em', sm: '22em' } }} >
        <Container className="reg-container" sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '2em'}}>
            ...
            <Box sx={{ display: 'flex', justifyContent: { lg: 'flex-end', xs: 'center' }, position: 'relative', bottom: { lg: '5em', xl: '6em', xs: '3em', }, left: { lg: '7em', xl: '10em', xs: '0' } }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: '2em', border: '1px solid #E6E6E6', borderRadius: '11.8321px', justifyContent: 'center', alignItems: 'center', width: 'fit-content', p: { lg: '5em',xs: '2em' }, height: 'fit-content', ml: { xl: '6em', lg: '6em' }, mr: { xs: '2em' }, position: 'relative', bottom: { lg: '3em' } }}>

                    

                    <Box sx={{ pr: '6.1em', display: 'flex', flexDirection: 'column', gap: '1.4em' }}>
                        <Box>
                    ...
                    <Link href="/registration" style={{ zIndex: '999' }}>      
                        <Box sx={{  boxShadow: '0px 4px 14px 1px rgba(0, 0, 0, 0.04)', borderRadius: '10px', height: { lg: '3.5em', md: '4em', sm: '4.5em', xs: '3.5em' }, display: 'flex', width: '21em', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer',  border: ' 1px solid #E6E6E6' }}>
                    ...
                    <Link href="/registration" style={{ zIndex: '999' }}>      
                        <Box sx={{ boxShadow: '0px 4px 14px 1px rgba(0, 0, 0, 0.04)', border: ' 1px solid #E6E6E6', borderRadius: '6px', height: { lg: '3.5em', md: '4em', sm: '4.5em', xs: '3.5em' }, display: 'flex', width: '21em', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer' }}>
                            <Box sx={{ display: 'flex', gap: '1.7em', margin: '.9em', justifyContent: 'center', alignItems: 'center', pl: '.8em' }}>
